resource "aws_cognito_user_pool" "account_manage_user_pool" {
  lifecycle {
    ignore_changes = [
      schema
    ]
  ...
  name = "${var.account_manage_prefix}-user-pool"
...
resource "aws_cognito_user_pool_client" "account_manager_user_pool_client" {
  name            = "${var.account_manage_prefix}-user-pool-client"
  user_pool_id    = aws_cognito_user_pool.account_manage_user_pool.id
